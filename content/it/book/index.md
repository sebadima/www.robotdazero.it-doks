...
<h5 tyle ="padding: 2px; color: #ffffff ; background-color: #E75B2D; ">
...
<div class="bz-container">
  <h5 class="bz-btmmargin">Prenota la tua chiamata...</h5>
  <form action="https://formspree.io/f/xyybpbln" method="POST">
    <div class="bz-left">
      <input type="hidden" name="_language" value="it"/>
      <input class="bz-btmmargin" type="text" id="name" placeholder="Nome"/>
      <input class="bz-btmmargin" type="text" id="messaggio"  name="message" placeholder="Telefono" required/>
    </div>
