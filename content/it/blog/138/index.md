...
La "mission" di Espressif si concentra soprattutto sulle soluzioni per L'Intelligenza artificiale delle cose (<a href="https://www.internet4things.it/iot-library/artificial-intelligence-of-things-aiot-che-cose-e-come-funziona/" target="_blank">AIoT</a>). Con l'ESP32 è riuscita a conciliare una discreta potenza di elaborazione con la connettività wireless a basso consumo. L'antenato dell'ESP32 e cioè la scheda ESP8266 aveva aperto la strada pochi anni prima mondo IOT creando per la prima volta un dispositivo single-chip facile da usare con tutto il software necessario per comunicare via Wi-Fi.
